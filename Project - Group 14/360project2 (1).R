...
data_yüztemizleyici=rbind(data_yüztemizleyici,data.table(event_date=as.Date("2021-06-25")),fill=T)
data_yüztemizleyici[event_date=="2021-06-25", is_discount:=0]
data_yüztemizleyici[event_date=="2021-06-25", price := nextday_yüztemizleyici_price]
data_yüztemizleyici[event_date=="2021-06-25", basket_count:= nextday_yüztemizleyici_basket]
...
data_ýslakmendil=rbind(data_ýslakmendil,data.table(event_date=as.Date("2021-06-25")),fill=T)
data_ýslakmendil[event_date=="2021-06-25", is_discount:=0]
data_ýslakmendil[event_date=="2021-06-25", basket_count := nextday_ýslakmendil_basket]
data_ýslakmendil[event_date=="2021-06-25", category_sold := nextday_ýslakmendil_catsold]
data_ýslakmendil[event_date=="2021-06-25", category_visits := nextday_ýslakmendil_catvis]
data_ýslakmendil[event_date=="2021-06-25", category_favored := nextday_ýslakmendil_catfav]
...
data_kulaklýk=rbind(data_kulaklýk,data.table(event_date=as.Date("2021-06-25")),fill=T)
data_kulaklýk[event_date=="2021-06-25", is_discount:=0]
data_kulaklýk[event_date=="2021-06-25", visit_count := nextday_kulaklýk_visit]
data_kulaklýk[event_date=="2021-06-25", basket_count := nextday_kulaklýk_basket]
data_kulaklýk[event_date=="2021-06-25", category_sold := nextday_kulaklýk_catsold]
data_kulaklýk[event_date=="2021-06-25", category_visits := nextday_kulaklýk_catvis]
...
data_süpürge=rbind(data_süpürge,data.table(event_date=as.Date("2021-06-25")),fill=T)
data_süpürge[event_date=="2021-06-25", favored_count := nextday_süpürge_favcount]
data_süpürge[event_date=="2021-06-25", basket_count := nextday_süpürge_basket]
data_süpürge[event_date=="2021-06-25", category_sold := nextday_süpürge_catsold]
data_süpürge[event_date=="2021-06-25", category_visits := nextday_süpürge_catvis]
data_süpürge[event_date=="2021-06-25", ty_visits := nextday_süpürge_tyvis]
...
data_fýrça=rbind(data_fýrça,data.table(event_date=as.Date("2021-06-25")),fill=T)
data_fýrça[event_date=="2021-06-25", is_discount:=0]
data_fýrça[event_date=="2021-06-25", price := nextday_fýrça_price]
data_fýrça[event_date=="2021-06-25", visit_count := nextday_fýrça_viscount]
data_fýrça[event_date=="2021-06-25", favored_count := nextday_fýrça_favcount]
data_fýrça[event_date=="2021-06-25", basket_count := nextday_fýrça_basket]
data_fýrça[event_date=="2021-06-25", ty_visits := nextday_fýrça_tyvis]
